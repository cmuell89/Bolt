...
from utils.exceptions import ClassificationModelError, DatabaseError
...
class ClassificationModelBuilder:
    ...
    def _build_binary_classification_pipeline(self, keywords):
        ...
        """
        try:
            """ Sci-kit learn vectorizors are combined together using FeatureUnion """
            ...
            """ Feature Selection is performed using term frequency inverse document frequency (TFIDF) procedure """
...
class BinaryClassifier(AbstractClassifier):
    ...
    def classify(self, document):
        ...
        except exceptions.NotFittedError as error:
            raise ClassificationModelError(repr(error))
...
class IntentClassifier(AbstractClassifier):
    ...
    def classify(self, document):
        ...
        try:
            ...
            raise ClassificationModelError(error.value)
